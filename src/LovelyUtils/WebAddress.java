...
import static LovelyUtils.UrlUtils.GOOD_IRI_CHAR;
 ...
 *
 */
public class WebAddress extends MenuItem {
        ...
        if (m.matches()) {
            ...
            if (t != null && t.length() > 0) {
                ...
                try {
                    ...
                    throw new ParseException("Bad port", mPort);
                }
            }
            ...
            throw new ParseException("Bad address", mPort);
        }
    ...
    public boolean equals(Object o) {
        return this.getPath().equals(((WebAddress)o).getPath());
    }
}
